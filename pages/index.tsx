...
export default function Home() {
  ...
  const mounted = useIsMounted(); //To make sure our wallet button renders only until after the component has mounted
      ...
      <div className={styles.main}>
        ...
        {wallet && (
          <div className={styles.message_bar}>
            ...
            >
              {message ? "Update the Message" : "Save the Message"}
            </button>
          </div>
        )}
